...
const Home = () => {
  ...
  const getAllPizzas = async () => {
    ...
    // const sortOrder =
    //   sortName.sortProps === "price" || sortName.sortProps === "title"
    //     ? `&order=${sortName.sortOrder}`
    //     : `&order=desc`;
    try {
      await axios
        .get(
          `https://63276da95731f3db99593be8.mockapi.io/products?${category}&sortBy=${sortName.sortProps}&order=${sortName.sortOrder}`
        )
